...
return cljs.core.vec.call(null,cljs.core.sort_by.call(null,cljs.core.juxt.call(null,new cljs.core.Keyword(null,"point","point",1813198264)),(function (p1__42513_SHARP_,p2__42514_SHARP_){
return (p1__42513_SHARP_ > p2__42514_SHARP_);
}),users));
}));
});
...
return React.createElement("div",({"key": index, "className": "list-user-main"}),(function (){var attrs42516 = cljs.core.get.call(null,user,new cljs.core.Keyword(null,"name","name",1843675177));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs42516))?sablono.interpreter.attributes.call(null,attrs42516):null),((cljs.core.map_QMARK_.call(null,attrs42516))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs42516)], null)));
})(),React.createElement("div",null,sablono.interpreter.interpret.call(null,cljs.core.get.call(null,user,new cljs.core.Keyword(null,"point","point",1813198264)))),sablono.interpreter.create_element.call(null,"input",({"type": "button", "value": "+", "onClick": (function (){
return user_mgmt.core.increment_point.call(null,state,index);
})})),sablono.interpreter.create_element.call(null,"input",({"type": "button", "value": "-", "onClick": (function (){
...
return cljs.core.map_indexed.call(null,(function (p1__42517_SHARP_,p2__42518_SHARP_){
return user_mgmt.core.list_user.call(null,state,p1__42517_SHARP_,p2__42518_SHARP_);
...
return React.createElement("div",({"className": "input-tag"}),sablono.interpreter.create_element.call(null,"input",({"type": "text", "placeholder": "Enter user name", "size": "50", "onChange": (function (p1__42519_SHARP_){
return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"new-user","new-user",1575436062),p1__42519_SHARP_.target.value);
...
var attrs42521 = user_mgmt.core.list_users.call(null,state);
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs42521))?sablono.interpreter.attributes.call(null,attrs42521):null),((cljs.core.map_QMARK_.call(null,attrs42521))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,user_mgmt.core.get_input_interface.call(null,state))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs42521),sablono.interpreter.interpret.call(null,user_mgmt.core.get_input_interface.call(null,state))], null)));
});
/**
...
//# sourceMappingURL=core.js.map?rel=1475741223298