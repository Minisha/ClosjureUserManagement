...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__39353_SHARP_){
return ((p1__39353_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__39353_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__39355,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__39355;
}
});
...
var len__25865__auto___39358 = arguments.length;
var i__25866__auto___39359 = (0);
while(true){
if((i__25866__auto___39359 < len__25865__auto___39358)){
args__25872__auto__.push((arguments[i__25866__auto___39359]));

var G__39360 = (i__25866__auto___39359 + (1));
i__25866__auto___39359 = G__39360;
continue;
} else {
}
break;
...
var G__39357 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__39357,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__39357;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq39356){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39356));
});
...
var vec__39366 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__39366,(0),null);
var names = cljs.core.nth.call(null,vec__39366,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__39366,tag_name,names){
return (function (p1__39361_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__39361_SHARP_));
});})(matches,vec__39366,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__39366,tag_name,names){
return (function (p1__39362_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__39362_SHARP_));
});})(matches,vec__39366,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__39369){
var vec__39376 = p__39369;
var seq__39377 = cljs.core.seq.call(null,vec__39376);
var first__39378 = cljs.core.first.call(null,seq__39377);
var seq__39377__$1 = cljs.core.next.call(null,seq__39377);
var tag = first__39378;
var content = seq__39377__$1;
...
var vec__39379 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__39379,(0),null);
var id = cljs.core.nth.call(null,vec__39379,(1),null);
var class$ = cljs.core.nth.call(null,vec__39379,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1475623451190