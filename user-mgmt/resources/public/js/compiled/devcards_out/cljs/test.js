...
var args33011 = [];
var len__25865__auto___33015 = arguments.length;
var i__25866__auto___33016 = (0);
while(true){
if((i__25866__auto___33016 < len__25865__auto___33015)){
args33011.push((arguments[i__25866__auto___33016]));

var G__33017 = (i__25866__auto___33016 + (1));
i__25866__auto___33016 = G__33017;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args33011.length)].join('')));
...
var G__33014 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33014,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33014;
}
});
...
var len__25865__auto___33022 = arguments.length;
var i__25866__auto___33023 = (0);
while(true){
if((i__25866__auto___33023 < len__25865__auto___33022)){
args__25872__auto__.push((arguments[i__25866__auto___33023]));

var G__33024 = (i__25866__auto___33023 + (1));
i__25866__auto___33023 = G__33024;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33019){
var G__33020 = cljs.core.first.call(null,seq33019);
var seq33019__$1 = cljs.core.next.call(null,seq33019);
var G__33021 = cljs.core.first.call(null,seq33019__$1);
var seq33019__$2 = cljs.core.next.call(null,seq33019__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33020,G__33021,seq33019__$2);
});
...
var file = cljs.core.get.call(null,map__33028__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33028__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33028__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33028,map__33028__$1,file,line,column){
return (function (p1__33025_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33025_SHARP_));
});})(map__33028,map__33028__$1,file,line,column))
...
var temp__4657__auto___33030 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33030)){
var message_33031 = temp__4657__auto___33030;
cljs.core.println.call(null,message_33031);
} else {
}
...
var temp__4657__auto___33032 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33032)){
var message_33033 = temp__4657__auto___33032;
cljs.core.println.call(null,message_33033);
} else {
}
...
var G__33043 = exception.stack;
var G__33043__$1 = (((G__33043 == null))?null:clojure.string.split_lines.call(null,G__33043));
var G__33043__$2 = (((G__33043__$1 == null))?null:cljs.core.get.call(null,G__33043__$1,depth));
if((G__33043__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33043__$2);
}
} else {
...
var vec__33044 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33044,(0),null);
var column = cljs.core.nth.call(null,vec__33044,(1),null);
var vec__33047 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33047,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33047,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33047,(2),null);
...
var m__$1 = (function (){var G__33051 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__33051) {
case "fail":
...
var G__33057 = (function (){var G__33056 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33056);
} else {
return G__33056;
}
})();
...
return cljs.core.vary_meta.call(null,G__33059,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e33062){var e = e33062;
var G__33063 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__33063) {
...
var vec__33068 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33068,(0),null);
var types = vec__33068;
...
return cljs.core.map.call(null,(function (p__33080){
var vec__33081 = p__33080;
var ns = cljs.core.nth.call(null,vec__33081,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33081,(1),null);
return ((function (vec__33081,ns,vars__$1){
return (function (){
...
var G__33084 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__33084) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1){
return (function (){
var seq__33085 = cljs.core.seq.call(null,vars__$1);
var chunk__33086 = null;
var count__33087 = (0);
var i__33088 = (0);
while(true){
if((i__33088 < count__33087)){
var v = cljs.core._nth.call(null,chunk__33086,i__33088);
var temp__4657__auto___33090 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33090)){
var t_33091 = temp__4657__auto___33090;
each_fixture_fn.call(null,((function (seq__33085,chunk__33086,count__33087,i__33088,t_33091,temp__4657__auto___33090,v,each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33091)));
});})(seq__33085,chunk__33086,count__33087,i__33088,t_33091,temp__4657__auto___33090,v,each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1))
);
} else {
}

var G__33092 = seq__33085;
var G__33093 = chunk__33086;
var G__33094 = count__33087;
var G__33095 = (i__33088 + (1));
seq__33085 = G__33092;
chunk__33086 = G__33093;
count__33087 = G__33094;
i__33088 = G__33095;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__33085);
if(temp__4657__auto__){
var seq__33085__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33085__$1)){
var c__25601__auto__ = cljs.core.chunk_first.call(null,seq__33085__$1);
var G__33096 = cljs.core.chunk_rest.call(null,seq__33085__$1);
var G__33097 = c__25601__auto__;
var G__33098 = cljs.core.count.call(null,c__25601__auto__);
var G__33099 = (0);
seq__33085 = G__33096;
chunk__33086 = G__33097;
count__33087 = G__33098;
i__33088 = G__33099;
continue;
} else {
var v = cljs.core.first.call(null,seq__33085__$1);
var temp__4657__auto___33100__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33100__$1)){
var t_33101 = temp__4657__auto___33100__$1;
each_fixture_fn.call(null,((function (seq__33085,chunk__33086,count__33087,i__33088,t_33101,temp__4657__auto___33100__$1,v,seq__33085__$1,temp__4657__auto__,each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33101)));
});})(seq__33085,chunk__33086,count__33087,i__33088,t_33101,temp__4657__auto___33100__$1,v,seq__33085__$1,temp__4657__auto__,each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1))
);
} else {
}

var G__33102 = cljs.core.next.call(null,seq__33085__$1);
var G__33103 = null;
var G__33104 = (0);
var G__33105 = (0);
seq__33085 = G__33102;
chunk__33086 = G__33103;
count__33087 = G__33104;
i__33088 = G__33105;
continue;
}
} else {
...
});})(each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1))
);
});})(each_fixture_fn,G__33084,env,once_fixtures,each_fixtures,vec__33081,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1475620901014